...
# Exploratory Data Analysis on migration trend on countries of destination and origin
...
In aggregate, international migrants as a percentage of total population does not seem to be a high number. On average around 3% over the years. Let's dig deeper to get more insights.

There are three different classifications in the combined data set. Let's show graphically the international migrants as a percentage of total population over time in order to check trends.
...
Let's analyse the twenty countries hosting the largest numbers of international migrants (millions)
```{r}
...
(ggparcoord(df_6, columns = 3:9, groupColumn = 1, scale="globalminmax", alphaLines = 0.5, title = "Countries hosting the largest numbers of migrants") + 
